...
class InfMatterSPBasis: public SPBasis{
	public:
		...
		InfMatterSPBasis(std::size_t basisIndicatorIn, double densityIn, std::size_t tzMaxIn, std::size_t nShellsIn, std::size_t nParticlesIn);
