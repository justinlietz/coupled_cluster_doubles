...
void InfMatterSPBasis::setUpChannelValues(){
	...
	this->chan3BValue = new ChannelBundle[this->n3BodyChannels];
...
int InfMatterSPBasis::checkSympqrs(std::size_t p, std::size_t q, std::size_t r, std::size_t s){
	printf("InfMatterSPBasis::checkSympqrs should not be called\n");
	return 0;
}

int InfMatterSPBasis::check3BChanSym(int p, int q, int r, int chan3B){
	int result = 0;
