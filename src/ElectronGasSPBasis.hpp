...
#ifndef ElectronGasSPBasis_hpp_
#define ElectronGasSPBasis_hpp_
...
class ElectronGasSPBasis: public SPBasis{
	public:
		...
		double boxLength;
		GasBundle * chanValue;
		GasBundle * chan3BValue;

		GasBundle * chanModValue;
		...
		ElectronGasSPBasis(std::size_t basisIndicatorIn, double densityIn, std::size_t tzMaxIn, std::size_t nShellsIn, std::size_t nParticlesIn);
		...
		int check3BChanSym(int p, int q, int r, int chan3B);
